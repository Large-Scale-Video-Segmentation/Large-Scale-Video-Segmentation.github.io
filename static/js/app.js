...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-542fd968","hasScoped":false,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/template-compiler/preprocessor.js?engine=pug!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/app.vue
...
function injectStyle (ssrContext) {
  __webpack_require__("sNlf")
  __webpack_require__("Yjid")
}
...
// CONCATENATED MODULE: ./node_modules/ts-loader!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./src/pages/leaderboard.vue
var leaderboard___extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
    return function (d, b) {
...
var leaderboard___decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    return c > 3 && r && Object.defineProperty(target, key, r), r;
...
var leaderboard_LeaderboardPage = /** @class */ (function (_super) {
    leaderboard___extends(LeaderboardPage, _super);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-1e77a25e","hasScoped":true,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/template-compiler/preprocessor.js?engine=pug!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/pages/leaderboard.vue
var leaderboard_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _vm._m(0)}
var leaderboard_staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"page-leaderboard"}},[_c('section',{staticClass:"section",attrs:{"id":"display-section"}},[_c('div',{staticClass:"container content"},[_c('div',{staticClass:"section"},[_c('h1',{staticClass:"title"},[_vm._v("Leaderboard")])]),_c('div',{staticClass:"section"},[_c('h1',{staticClass:"title is-4"},[_c('strong',[_vm._v("1st")]),_vm._v(": Jono")]),_c('h1',{staticClass:"title is-5"},[_vm._v("Jonathon Luiten, Paul Voigtlaender, Bastian Leibe")]),_c('h1',{staticClass:"title is-5"},[_vm._v("Computer Vision Group, RWTH Aachen University, Germany")]),_c('p',[_vm._v("We evaluate our PReMVOS algorithm (Proposal-generation, Refinement and Merging for Video Object Segmentation) on the new YouTube-VOS dataset for the task of semi-supervised video object segmentation (VOS). This task consists of automatically generating accurate and consistent pixel masks for multiple objects in a video sequence, given the object’s first-frame ground truth annotations. The new YouTube-VOS dataset and the corresponding challenge, the 1st Large-scale Video Object Segmentation Challenge, provide a much larger scale evaluation than any previous VOS benchmarks. Our method achieves the best results in the 2018 Large-scale Video Object Segmentation Challenge with a J&F overall mean score over both known and unknown categories of 72.2.")]),_c('p',[_c('a',{attrs:{"href":"/static/reports/Jono.pdf"}},[_vm._v("[Tech Report]")])])]),_c('div',{staticClass:"section"},[_c('h1',{staticClass:"title is-4"},[_c('strong',[_vm._v("2nd")]),_vm._v(": speeding_zZ")]),_c('h1',{staticClass:"title is-5"},[_vm._v("Zilong Huang*, Qiang Zhou*, Lichao Huang, Han Shen, Yongchao Gong, Chang Huang, Wenyu Liu, Xinggang Wang (*equal contribution & interns of Horizon Robotics)")]),_c('h1',{staticClass:"title is-5"},[_vm._v("Huazhong University of Science and Technology, Horizon Robotics.")]),_c('p',[_vm._v("Proposal, Tracking & Segmentation (PTS): A cascaded network for video object segmentation")]),_c('p',[_vm._v("We propose a novel video object segmentation architecture which can capture long-term temporal information and handle scale variance in objects.")]),_c('p',[_vm._v("The proposed architecture consists of three components: Region Proposal Network, Object Tracking Network, and Reference-Guided Segmentation Network. The Region Proposal Network is pre-trained on COCO dataset and provides object candidate boxes. Inspired by MDNet, Object Tracking Network is designed to score the candidate boxes and updated online for adapting to large and fast changes in object appearance. Then, the box with the highest score is selected to crop and resize the frame for normalizing the scale variation of objects. Finally, Reference-Guided Segmentation Network will make use of both cropped region with previous mask and the reference frame to segment target object.")]),_c('p',[_vm._v("Besides YouTube-VOS dataset, COCO dataset is used to pre-train Region Proposal Network in this competition.")])]),_c('div',{staticClass:"section"},[_c('h1',{staticClass:"title is-4"},[_c('strong',[_vm._v("3rd")]),_vm._v(": mikirui")]),_c('h1',{staticClass:"title is-5"},[_vm._v("Huaijia Lin*, Ruizheng Wu*, Xiaogang Xu, Xiaojuan Qi, Jiaya Jia (* indicates equal contribution)")]),_c('h1',{staticClass:"title is-5"},[_vm._v("The Chinese University of Hong Kong & Tencent YouTu X-Lab")]),_c('p',[_vm._v("Our method consists of two major modules, mask propagation module and re-identification module. Our mask propagation module is built based on flownet2, while taking multiple previous frames and its corresponding masks as guidance to train a flow-appearance propagation network for masks propagation between adjacent frames. For re-identification module, we train a network to generate a 128-dim feature for each position, following the paper \"Blazingly Fast Video Object Segmentation with Pixel-Wise Metric Learning\". For any two foreground objects, we calculate the number of pixels whose distances to the foreground object in the first image is smaller than that of the background pixels. This indicates similarity degree of two objects. In the inference process, the mask propagated from the previous frame and masks generated by the mask-rcnn are treated as the candidate masks. Then the flownet2 and re-identification modules are used to calculate the appearance and motion consistency for each mask. Finally, the masks with highest score is set to the prediction of current frame. No online training is used in our method. Our method achieve 69.7% in validation set and 69.9% in test set.")]),_c('p',[_c('a',{attrs:{"href":"/static/reports/PMSNet.pdf"}},[_vm._v("[Slides]")])])]),_c('div',{staticClass:"section"},[_c('h1',{staticClass:"title is-4"},[_c('strong',[_vm._v("4th")]),_vm._v(": hi.nineare")]),_c('h1',{staticClass:"title is-5"},[_vm._v("University of Texas at Austin & Preferred Networks")]),_c('p',[_vm._v("A combined approach of meta-learning and mask propagation is used for the competition. Basically, the given target objects of a video are tracked by a fine-tuned neural network with given first frame annotation. Yet, the finetuning process is fast and effective because we used a meta-trained network using REPTILE meta-learning framework. Afterward, the output mask from the finetuned network is enhanced with another neural network in which its input is a channel-wise concatenation of (the previous frame, the previous frame prediction, current frame, current frame prediction by the finetuned network). For both of the network, we used a PSP-network pretrained for VOC 2012. The given frames of videos are preprocessed with various operations (crop, reflection, etc..) for training and frames are resized to 600x1200.")])]),_c('div',{staticClass:"section"},[_c('h1',{staticClass:"title is-4"},[_c('strong',[_vm._v("5th")]),_vm._v(": sunpeng")]),_c('h1',{staticClass:"title is-5"},[_vm._v("Zhejiang University & Renmin University of China & Institute of Remote Sensing and Digital Earth (RADI) & Chinese Academy of Sciences (CAS)")]),_c('p',[_vm._v("We propose an online video segmentation method for temporal images. Our online video segmentation with Mask-RCNN and Re-id (OVSMAR) model includes an online mask propagation module, a Mask-RCNN module and a Object-Reid module. The online mask propagation module takes the warped prediction result of the previous frame together with the optical flow as input, and outputs the segmentation result of the current frame. This process can be trained end-to-end online with continuous images. Starting from weights pre-trained on ImageNet, COCO and PASCAL VOC, we train this module on Youtube Datasets online. We use the Re-id module to retrieve instances which are missing due to occlusion, motion blur, and out of the camera. We use the Mask-RCNN module trained on MS-COCO to find the missing object which similarity is greater than the threshold, then use the Mask-RCNN segmentation result as the coarse prediction of the object for online mask propagation module, and propagate both forward and backward.      With these three modules iteratively applied, our OVSMAR records a global mean (Region Jaccard and Boundary F measure) of 0.678 on valid dataset and 0.672 on test set.")])]),_c('div',{staticClass:"section"},[_c('h1',{staticClass:"title is-4"},[_c('strong',[_vm._v("6th")]),_vm._v(": random_name")]),_c('h1',{staticClass:"title is-5"},[_vm._v("ByteDance AI Lab")]),_c('p',[_vm._v("We first train model on the trainset to distinguish the general object, then fine-tune the model on the augment data of the first frame of the testset videos to distinguish the specific object,  and finally complete the inference with the object tracking bbox.")])]),_c('div',{staticClass:"section"},[_c('h1',{staticClass:"title is-4"},[_c('strong',[_vm._v("7th")]),_vm._v(": kduarte")])]),_c('div',{staticClass:"section"},[_c('h1',{staticClass:"title is-4"},[_c('strong',[_vm._v("8th")]),_vm._v(": SnowFlower")]),_c('h1',{staticClass:"title is-5"},[_vm._v("Qiong WANG")]),_c('h1',{staticClass:"title is-5"},[_vm._v("Univ Rennes, INSA Rennes, CNRS, IETR (Institut d'Electronique et de Telecommunication de Rennes) - UMR 6164, F-35000 Rennes, France")]),_c('p',[_vm._v("We propose a semantic warping-based video object segmentation (SWVOS) method in the 1st Large-scale Video Object Segmentation Challenge 2018. It firstly addresses the problem of generating fine bounding box for each object, and then produces accurate pixel proposal with a mask-refinement network. More specifically, 1) the mask of an annotated object is warped into other frames.  Considering that the accuracy of warped masks differs due to the deformations, occlusions, and intensity changes in videos, a Warping Confidence approach is proposed to differentiate the warped masks. 2) The warped masks with a high confidence, i.e., within a fine bounding box, are directly fed into a mask-refinement network to get the proposal masks. 3) The others are coped with to obtain fine bounding boxes: those with a middle confidence are put into a coarse-to-fine (CTF) bounding box pipeline, and those with a low confidence are re-warped using a semantics-selection (SEMS) method. For semantics, the Youtube-2018 dataset and COCO dataset are applied for training. Additionally, when occlusion occurs in CTF and SEMS, a few random frames from previous frames are used to detect and/or rewarp. 4) Multiple proposal masks in each video are merged by taking into account the warping confidence. The experimental results show the effectiveness of the proposed approach on the large-scale Youtube-2018 dataset.")])])])])])}]
var leaderboard_esExports = { render: leaderboard_render, staticRenderFns: leaderboard_staticRenderFns }
/* harmony default export */ var pages_leaderboard = (leaderboard_esExports);
// CONCATENATED MODULE: ./src/pages/leaderboard.vue
function leaderboard_injectStyle (ssrContext) {
  __webpack_require__("5B3B")
}
var leaderboard_normalizeComponent = __webpack_require__("VU/8")
/* script */
...
/* template functional */
var leaderboard___vue_template_functional__ = false
/* styles */
var leaderboard___vue_styles__ = leaderboard_injectStyle
/* scopeId */
var leaderboard___vue_scopeId__ = "data-v-1e77a25e"
/* moduleIdentifier (server only) */
var leaderboard___vue_module_identifier__ = null
var leaderboard_Component = leaderboard_normalizeComponent(
  leaderboard,
  pages_leaderboard,
  leaderboard___vue_template_functional__,
  leaderboard___vue_styles__,
  leaderboard___vue_scopeId__,
  leaderboard___vue_module_identifier__
)

/* harmony default export */ var src_pages_leaderboard = (leaderboard_Component.exports);
    ...
    routes: [
        {
            ...
            name: 'leaderboard',
            component: src_pages_leaderboard,
        }, {
            path: '/404',
